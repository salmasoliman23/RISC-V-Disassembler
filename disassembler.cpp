		...
		if(opcode == 0x3)
		{
			...
			if(opcode == 0x13)
			{
				...
				if (opcode == 0x63)
				{
					...
					I_imm = (Itemp11 << 11)|(Itemp1_4)|(Itemp5_10 << 5 )|(Itemp12 << 12);
				   ...
				   switch (funct3){
				    case 0:
				    	if(rs2 == 0)
				    cout <<"\tBEQZ\tx"<< rs1 << ", "<<I_imm<< "\n";				    		
				    	else
					    cout << "\tBEQ\tx" << rs1 << ", x" << rs2 << ", " << I_imm << "\n";
				    break;
				    case 1:
				    	if(rs2 == 0)
						    cout <<"\tBNEZ\tx"<< rs1 << ", "<<I_imm<< "\n";
						else
					    	cout <<"\tBNE\tx"<< rs1 <<", x"<<rs2<<", "<<I_imm<< "\n";
				    break;
				    case 4:cout <<"\tBLT\tx"<< rs1 <<", x"<<rs2<<", "<<I_imm<< "\n";
				    break;
					case 5:cout <<"\tBGE\tx"<< rs1 <<", x"<<rs2<<", "<<I_imm<< "\n";
				    break;
					case 6:cout <<"\tBLTU\tx"<< rs1 <<", x"<<rs2<<", "<<I_imm<< "\n";
				    break;
				    case 7:cout <<"\tBGEU\tx"<< rs1 <<", x"<<rs2<<", "<<I_imm<< "\n";
				    break;
					...
					if (opcode == 0x37)
						...
						if (opcode == 0x17){
						    ...
						    if (opcode == 0x6f){
							    ...
							    J_imm= (Jtemp12_19 << 12)|(Jtemp11 << 11)|(Jtemp1_10)|(Jtemp20 << 20);
...
int main(int argc, char *argv[]){
	...
	if(argc<2) emitError("use: disasm <machine_code_file_name>\n");
